...
sf::IntRect Collision::GetAABB(const sf::Sprite& Object) {
    ...
    sf::Transform t = Object.getTransform();
    sf::Vector2f pos = t.transformPoint(sf::Vector2f(0, 0));

    //Store the size so we can calculate the other corners
    sf::Vector2f size(Object.getLocalBounds().width, Object.getLocalBounds().height);
    ...
    AABB.top = static_cast<int> (pos.x);
    AABB.left =  static_cast<int> (pos.y);
    return AABB;
}
...
bool Collision::BoundingBoxTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
    ...
    sf::Vector2f HalfSize1(Object1.getLocalBounds().width, Object1.getLocalBounds().height);
    sf::Vector2f HalfSize2(Object2.getLocalBounds().width, Object2.getLocalBounds().height);
...
bool Collision::BoundingBoxTest(const sf::RectangleShape& Object1, const wall& Object2)
{

    sf::Vector2f A, B, C, BL, TR;
    sf::Vector2f HalfSize1(Object1.getLocalBounds().width, Object1.getLocalBounds().height);
    sf::Vector2f HalfSize2(Object2.get_sprite().getLocalBounds().width, Object2.get_sprite().getLocalBounds().height);
    ...
    HalfSize2.y /= 2;
    //Get the Angle we're working on
    float Angle = Object1.getRotation() - Object2.get_sprite().getRotation();
    float CosA = cos(Angle * RADIANS_PER_DEGREE);
    float SinA = sin(Angle * RADIANS_PER_DEGREE);
    ...
    C = RotatePoint(C, Object2.get_sprite().getRotation());
