...
std::vector<monster_data> init_monster_data()
{
    ...
    data[monster::type::player].melee_damage = 0;
...
std::vector<bullet_data> init_bullet_data()
{
    ...
    data[bullet_type::pistol_bullet].damage = 24;
    ...
    data[bullet_type::shotgun_bullet].damage = 10;
...
std::vector<pickup_data> init_pickup_data()
{
    ...
    data[pickup::type::sm_ammo].action = monster::monster_ammo_pickup(pistol_bullet, 16);
    data[pickup::type::sh_ammo].texture = textures::entities;
    data[pickup::type::sh_ammo].texture_rect = sf::IntRect(10,5,5,5);
    data[pickup::type::sh_ammo].action = monster::monster_ammo_pickup(shotgun_bullet, 8);
    data[pickup::type::rk_ammo].texture = textures::entities;
    data[pickup::type::rk_ammo].texture_rect = sf::IntRect(10,15,5,5);
    data[pickup::type::rk_ammo].action = monster::monster_ammo_pickup(rocket_shell, 4);
...
std::vector<weapon_data> init_weapon_data()
{
    ...
    data[weapon_type::small_pistol].reload_speed = 200;
    ...
    data[weapon_type::basic_shotgun].reload_speed = 400;
...
std::vector<animation_data> init_animation_data()
{
    ...
    data[animation::type::player_walk].duration = sf::milliseconds(600);
    ...
    data[animation::type::small_mutant_walk].texture = textures::small_mutant_walk;
    data[animation::type::small_mutant_walk].texture_rect = sf::IntRect(0, 0, 72, 7);
    data[animation::type::small_mutant_walk].duration = sf::milliseconds(450);
