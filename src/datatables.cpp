...
std::vector<bullet_data> init_bullet_data()
{
    ...
    data[bullet_type::shotgun_bullet].damage = 2;
...
std::vector<pickup_data> init_pickup_data()
{
    ...
    data[pickup::type::sm_ammo].action = monster::monster_ammo_pickup(pistol_bullet, 12);
    data[pickup::type::sm_health_pack].texture = textures::sm_health_pack;
    data[pickup::type::sm_health_pack].action = monster::monster_healer(5);
...
std::vector<weapon_data> init_weapon_data()
{
    ...
    data[weapon_type::small_pistol].reload_speed = 400;
    ...
    data[weapon_type::basic_shotgun].spread = 8;
    data[weapon_type::basic_shotgun].reload_speed = 600;
    //data[weapon_type::basic_shotgun]
    return data;
}
